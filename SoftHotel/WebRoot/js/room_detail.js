        ...
        <div class="room_info">
             ...
             <h2>【${room.houseType}】</h2>
              <ul>
                ...
                <li><span>床型：</span>${room.bedType=='1'?'1.8米':(room.bedType=='2'?'1.5米':'1.2米')}大床/${room.bookNum}张</li>
       ...
       $("#guest_rooms").html(html);
         ...
         $("#btn_submit").click(function(){
              ...
              if(sessionStorage['loginName']){
                ...
                window.location.href="room/room_toOrder?rid="+rid;
  ...
  if(uname=='null'){
    alert("未进行登录，无法预订");
	  ...
	  $.ajax({
	    ...
	    data:{uname:uname,productId:pid,count:count,type:2},
